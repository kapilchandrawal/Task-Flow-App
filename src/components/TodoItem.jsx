      ...
      {isEditing ? (
        <>
          <input
            ...
            className="flex-1 px-3 py-1.5 bg-white/10 text-white placeholder-white/40 rounded-lg 
            focus:outline-none focus:ring-2 focus:ring-violet-500 font-medium text-sm border-white/10"
            autoFocus
          ></input>
        </>
      ) : (
        ...
        {isEditing ? (
          <>
            ...
            <button
              ...
              className="w-7 h-7 rounded-lg bg-white/10 text-white/60 hover:bg-white/20 hover:text-white 
            transition-all duration-300 flex items-center justify-center transform hover:scale-110 active:scale-95"
            >
              <X size={14} />
            </button>
          </>
          ...
          <>
            ...
            <button
              ...
              className="w-7 h-7 rounded-lg bg-rose/10 text-rose-300 hover:bg-rose-500 hover:text-white 
            transition-all duration-300 flex items-center justify-center transform hover:scale-110 active:scale-95 border border-rose-500/30"
            >
              <Trash2 size={14} />
            </button>
          </>
